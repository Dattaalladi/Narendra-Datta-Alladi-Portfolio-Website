...
//       <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md p-6">
//         <p className="text-gray-700 dark:text-gray-300 mb-4 italic">
//           "Datta brings a strong AI engineering skillset and a professional mindset that helped us streamline our AI research process."
//         </p>
//         <a
...
//         </a>
//         <li>
//        <strong>Phone:</strong> <a href="tel:+917337359621" className="text-blue-600 hover:underline">+91-7337259621</a>
//     </li>
...
//       // 👇 This hidden form lets Netlify register it```javascript
// import React, { useState, useEffect } from 'react';
// import { motion } from 'framer-motion';
// import { useInView } from 'react-intersection-observer';
// import { Sun, Moon, Github, Instagram, Eye, Linkedin, Mail, Download, ExternalLink, Brain, Code, Cloud, Database, Award, BookOpen } from 'lucide-react';
...
//           <SectionTitle>About Me</SectionTitle>
//           <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-xl shadow-xl p-8">
//             <p className="text-gray-600 dark:text-gray-300 mb-
...
//               <a 
//                 href="mailto:dattaalladi@gmail.com"
//                 className="inline-flex items-center text-blue-600 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-300 text-xl"
//               >
...
<Section id="contact">
  <div className="max-w-4xl mx-auto px-4">
    ...
    <Instagram size={24} />
      ...
      // 👇 This hidden form lets Netlify register it
      <form name="contact" data-netlify="true" hidden>
  <input type="text" name="name" />
  <input type="email" name="email" />
  <textarea name="message"></textarea>
